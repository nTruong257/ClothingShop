...
<body>
<%
    // Lấy danh sách sản phẩm từ Controller (chỉ khai báo 1 lần tại đây)
    List<Product> products = (List<Product>) request.getAttribute("products");

    // Đã xóa thumbnailImg vì không còn dùng nữa
%>
                ...
                <div class="filter-section">
                    ...
                    <div class="size-list" style="display: flex; flex-wrap: wrap; gap: 5px;">
                        <c:forEach items="${listSizes}" var="size">
                            <a href="#" class="btn btn-outline-secondary btn-sm" style="min-width: 35px;">${size}</a>
                        </c:forEach>
                    </div>
                </div>
