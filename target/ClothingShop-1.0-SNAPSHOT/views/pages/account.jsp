        ...
        <div class="row">
            <div class="col-md-3">
                <div class="sidebar">
                    ...
                    <a href="reset-pasword.jsp">Đổi mật khẩu</a>
                    <a href="order_status.jsp">Trạng thái đơn hàng</a>
                    <a href="order-history.jsp">Xem lịch sử mua hàng</a>
                    <a href="index.jsp" id="logoutBtn">Đăng xuất</a>
                </div>
            </div>
            <div class="col-md-9">
                <div class="content">
