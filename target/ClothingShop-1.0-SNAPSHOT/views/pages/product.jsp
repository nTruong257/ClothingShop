        ...
        <div class="header-main-row">
            ...
            <nav class="main-navigation" id="mainNavigation">
                ...
                <ul class="primary-nav-list">
                    ...
                    <li class="nav-item">
                        <a class="nav-link-primary" href="product.html">NAM</a>
                        <div class="submenu-container">
                            <div class="submenu-column">
                                <a href="product.html" class="submenu-title">ÁO NAM</a>
                                <ul class="submenu-items">
                                    <li><a href="product.html">Áo Khoác Nam</a></li>
                            ...
                            <div class="submenu-column">
                                <a href="product.html" class="submenu-title">QUẦN NAM</a>
                                <ul class="submenu-items">
                    ...
                    <li class="nav-item">
                        <a class="nav-link-primary" href="product.html">NỮ</a>
                        <div class="submenu-container">
                            <div class="submenu-column">
                                <a href="product.html" class="submenu-title">ÁO NỮ</a>
                                <ul class="submenu-items">
                            ...
                            <div class="submenu-column">
                                <a href="product.html" class="submenu-title">QUẦN / VÁY NỮ</a>
                                <ul class="submenu-items">
                    ...
                    <li class="nav-item">
                        <a class="nav-link-primary" href="product.html">Đồ đôi</a>
                        <div class="submenu-container">
                            <ul class="submenu-items">
                                    <li><a href="product.html">Áo khoác đôi</a></li>
                                    <li><a href="product.html">Áo thun đôi</a></li>
                                    <li><a href="product.html">Đồ bộ đôi</a></li>
                            </ul>
                        </div>
                    </li>
