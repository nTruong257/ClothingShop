            ...
            <section class="col-lg-9 col-md-8">
                ...
                <div class="sort-bar d-flex justify-content-end mb-3">
                    <select class="form-select w-auto" onchange="location = this.value;">
                        ...
                        <option value="${root}/product?sort=newest" ${currentSort == 'newest' ? 'selected' : ''}>Hàng mới
                            về
                        </option>
                        <option value="${root}/product?sort=bestseller" ${currentSort == 'bestseller' ? 'selected' : ''}>Sản
                            phẩm bán chạy
                        </option>
                        <option value="${root}/product?sort=price_asc" ${currentSort == 'price_asc' ? 'selected' : ''}>Giá
                            tăng dần
                        </option>
                        <option value="${root}/product?sort=price_desc" ${currentSort == 'price_desc' ? 'selected' : ''}>Giá
                            giảm dần
                        </option>
                    </select>
                </div>
                            ...
                            <a href="${root}/product_detail?id=<%=p.getProduct_id()%>"
                               class="product-card-link">
                                ...
                                <div class="product-info">
                                    <h5 class="product-name"><%=p.getProduct_name()%>
                                    </h5>
